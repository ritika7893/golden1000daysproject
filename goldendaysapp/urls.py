...
from .views import CandidateDetailAPIView, Intervention1CreateAPIView, LoginAPIView, QuestionnaireInterventionAPIView, RefreshTokenAPIView,ResetPasswordAPIView,UserListAPIView,CandidateAPIView
urlpatterns = [
